...
const navConfig = [
  ...
  // ----------------------------------------------------------------------
  {
    ...
    items: [
      ...
      { title: 'dashboard', path: PATH_DASHBOARD.general.banking, icon: ICONS.dashboard },
      { title: 'transactions', path: PATH_DASHBOARD.transactions.list, icon: ICONS.banking },
      { title: 'categories', path: PATH_DASHBOARD.categories.list, icon: ICONS.analytics },
      { title: 'rules', path: PATH_DASHBOARD.rules.list, icon: ICONS.analytics },
